...
$sql = "SELECT e.id_envio,e.codigo_guia,e.nombre_destinatario,e.fecha_registro,es.nombre_estado
        FROM envio e
...
<div class="app-card table-card">
    ...
    <table class="table table-hover align-middle">
        <thead><tr><th>Código guía</th><th>Destinatario</th><th>Fecha</th><th>Estado</th><th>Acciones</th></tr></thead>
        <tbody>
        <?php foreach ($envios as $envio): ?>
            <tr>
                ...
                <td><a class="btn btn-sm btn-blue" href="detalle_envio.php?id=<?php echo e($envio['id_envio']); ?>"><i class="bi bi-eye"></i> Ver detalle</a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
