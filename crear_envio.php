...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nombre === '' || $telefono === '' || $direccion === '' || $descripcion === '' || $peso === '') {
        ...
        try {
            ...
            if (!$estado) {
                throw new Exception("No existe el estado inicial 'Paquete registrado'. Ejecute la migración SQL.");
            }

            $idEstado = (int)$estado['id_estado'];

            $sql = "INSERT INTO envio
                    (codigo_guia, id_usuario_remitente, nombre_destinatario, telefono_destinatario,
                     direccion_destinatario, descripcion_paquete, peso, es_fragil, tipo_paquete,
                     estado_actual_id, observaciones, instrucciones_entrega)
                    VALUES
                    (:codigo, :usuario, :nombre, :telefono, :direccion, :descripcion, :peso,
                     :es_fragil, :tipo_paquete, :estado, :observaciones, :instrucciones)";
    ...
    <div class="card-body">
        ...
        <form method="POST" autocomplete="off">
            ...
            <div class="mb-3">
                ...
                <textarea name="instrucciones_entrega" class="form-control" rows="2" placeholder="Ej. Entregar de 8:00 a 16:00, llamar antes de llegar"></textarea>
            </div>
